...
PM_START_TEXT = """
*𝐇𝐞𝐥𝐥𝐨 {} !* 
✪ 𝐈'𝐦 𝐚𝐧 𝐚𝐧𝐢𝐦𝐞-𝐭𝐡𝐞𝐦𝐞 𝐦𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐭 𝐛𝐨𝐭 
──────────────────────── 
× *𝐔𝐩𝐭𝐢𝐦𝐞:* `{}`
 × `{}` *𝐮𝐬𝐞𝐫𝐬, 𝐚𝐜𝐫𝐨𝐬𝐬* `{}` *𝐜𝐡𝐚𝐭𝐬.*
 ────────────────────────
 ✪ 𝐇𝐢𝐭 /𝐡𝐞𝐥𝐩 𝐭𝐨 𝐬𝐞𝐞 𝐦𝐲 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬.
"""
...
KOMIPIC = (
    "https://telegra.ph/file/5e3bfecf8a0bc32bbff7a.jpg",
    "https://telegra.ph/file/d52d01b9590eea6f403ed.jpg",

)

KOMISTART = "https://te.legra.ph/file/12dac874dc3fbd9dc3f09.mp"
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                random.choice(KOMIPIC),caption=PM_START_TEXT.format(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text="Help",
                                url=f"https://t.me/komiXprobot?start=help",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                text="Add komi In Your Group",
                                url="t.me/KomiXprobot?startgroup=true".format(
